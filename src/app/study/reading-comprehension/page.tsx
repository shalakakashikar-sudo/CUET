...
import { Book, AlertTriangle, Lightbulb, ArrowRight, Table } from "lucide-react"
import Link from "next/link"

const PASSAGE_TYPES = [
  { type: "Factual / Informational", desc: "Based on facts, data, or info.", examples: "Stoicism, Tiger population, Indian handicrafts." },
  { type: "Narrative / Literary", desc: "A story told by a narrator; character-driven.", examples: "Arjun in Varanasi, cooking rice experiences." },
        ...
        <header className="mb-12 animate-fade-in-up">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-muted-foreground text-lg max-w-2xl">Master the art of extracting answers from 3 passages and 12 total questions. Accuracy is the only way to 60/60.</p>
            </div>
              ...
              <TabsContent value="approach" className="mt-8 space-y-6">
                <Card className="border-primary/20 bg-primary/5">
                  <CardHeader>
                    ...
                    <CardDescription className="text-foreground/70">Save time and prevent errors with this proven sequence.</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    {[
                      "Read all 4 questions for the passage FIRST (30 sec). Know what to look for.",
                      "Read only the FIRST and LAST line of each paragraph (90 sec) to find the skeleton.",
                      "Answer SPECIFIC INFORMATION questions. Verify from the exact line.",
                      "Answer WORD MEANING questions. Read 2 sentences before and after the word.",
              ...
              <TabsContent value="traps" className="mt-8">
                <div className="space-y-4">
                  {[
                    ...
                    { label: "True but NOT in passage", desc: "If the passage didn't say it, it's wrong—no matter how true it seems in real life." },
