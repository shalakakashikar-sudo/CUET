...
const RC_PASSAGES: Passage[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 24, text: "What specifically made Einstein restless and sleepless?", options: ["The hit on America", "The hit on Nagasaki", "The hit on Hiroshima", "Both Nagasaki and Hiroshima"], correct: 3, explanation: "The bombings of both Hiroshima and Nagasaki caused his immense agony and sleeplessness." },
      ...
      { id: 27, text: "Which philosopher did Einstein invite to inaugurate his new institution?", options: ["Bertrand Russell", "Albert Schweitzer", "Both philosophers", "Neither philosopher"], correct: 2, explanation: "Paragraph 6 mentions he invited 'two great philosophers, Bertrand Russell and Albert Schweitzer'." },
