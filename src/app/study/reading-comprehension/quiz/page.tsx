...
const RC_PASSAGES: Passage[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 36, text: "Interpret the change in Arjun's outlook on life throughout the passage:", options: ["He viewed every hardship as an essential brushstroke", "He became iindifferent to challenges", "He rejected the essential idea of change", "He focused solely on attaining commercial success"], correct: 0, explanation: "Arjun learned to see struggles as necessary parts of his journey." }
    ]
  },
  {
    id: "handicrafts",
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 48, text: "The author as a matured individual believes that his shy nature brought him:", options: ["Great advantage in life", "Unmatched joy and enchantment in life", "Disadvantage in rituals", "Media coverage"], correct: 0, explanation: "The author explicitly states 'it has been all to my advantage'." },
  ...
  },
  {
    ...
    description: "Exploring the historical evolution and structural importance of punctuation.",
    content: "While words convey meaning, punctuation provides the essential architecture that holds language together. In ancient times, texts were often written as a continuous stream of letters without spaces, a practice known as scriptura continua. It was the reader’s burden to decipher where one word ended and another began. The evolution of punctuation began in earnest when Aristophanes of Byzantium, a librarian in ancient Alexandria, introduced a system of dots to indicate pauses for breath during public readings. Over centuries, this system evolved. The invention of the printing press in the 15th century standardized marks like the comma, colon, and period. Today, punctuation marks act as the traffic signals of written communication. They dictate the rhythm of a sentence, clarify ambiguities, and convey the writer's tone. A simple misplaced comma can alter the entire meaning of a legal document or a heartfelt letter. Even in the modern digital age, where text messages often discard formal rules, the fundamental need to structure our thoughts remains. Having even an inkling of how to properly use a semicolon or an em dash empowers a writer to communicate with precision, transforming a jumble of words into a symphony of clear ideas.",
    questions: [
      { id: 101, text: "What was the primary purpose of the dot system introduced by Aristophanes of Byzantium?", options: ["To separate distinct paragraphs in legal documents", "To indicate pauses for breath during public readings", "To standardize the printing press format", "To replace the spaces between words"], correct: 1, explanation: "Aristophanes introduced dots specifically to help readers know when to pause for breath." },
      { id: 102, text: "Choose the option that is the Antonym of the word 'ambiguities' as used in the passage:", options: ["Uncertainties", "Clarities", "Nuances", "Complexities"], correct: 1, explanation: "Ambiguity refers to lack of clarity; therefore, clarity is its direct opposite." },
      { id: 103, text: "Identify the Figure of Speech used in the expression: \"punctuation marks act as the traffic signals of written communication.\"", options: ["Simile", "Personification", "Metaphor", "Oxymoron"], correct: 2, explanation: "It is a direct comparison between marks and traffic signals without using 'like' or 'as'." },
      { id: 104, text: "According to the passage, what was the primary difficulty of scriptura continua?", options: ["It lacked standardized spelling", "It was too expensive to print", "The reader had to figure out where words began and ended", "It was only understood by librarians"], correct: 2, explanation: "Without spaces or marks, readers had to 'decipher where one word ended and another began'." }
    ]
  },
  {
    id: "power-podium",
    title: "The Power of the Podium",
    description: "A narrative on overcoming the fear of public speaking through emotional connection.",
    content: "The school auditorium was a cavern of echoes, empty except for the lone figure of Rohan standing at the wooden podium. Tomorrow was the annual morning assembly, and he had been chosen to deliver the opening script. Rohan was terrified of public speaking; his voice usually abandoned him when more than three people looked his way. He looked down at the crumpled script in his hands. It was a beautiful piece, carefully woven with themes of unity, perseverance, and the importance of self-belief. He took a deep breath, the scent of floor wax and old velvet curtains filling his lungs. \"Good morning, respected Principal, teachers, and my dear friends,\" he whispered. The words fell flat. He remembered his mentor's advice: Don't just read the words; feel their weight. He squared his shoulders, visualized the bustling crowd that would fill the seats tomorrow, and started again. This time, his voice resonated with newfound strength, bouncing off the back walls. As he navigated the narrative of the script, he felt a spark of confidence ignite within him. The podium was no longer an object of fear, but a vessel. By the time he read the concluding thought for the day, Rohan knew he was ready.",
    questions: [
      { id: 105, text: "Arrange the events of the narrative in the correct chronological order:", options: ["D, B, A, E, C", "D, A, B, C, E", "B, D, A, E, C", "A, D, B, E, C"], correct: 0, explanation: "Sequence: Stood in auditorium (D), Whispered lines flatly (B), Visualized crowd (A), Voice resonated (E), Podium became vessel (C)." },
      { id: 106, text: "Choose the correct meaning of the word 'cavern' in the context of the first sentence:", options: ["A small, confined classroom", "A dark, underground cave", "A large, hollow, and echoing space", "A crowded and noisy environment"], correct: 2, explanation: "Contextually, 'cavern' describes the large, echoing nature of the empty school hall." },
      { id: 107, text: "What was the central theme of the script Rohan was preparing to read?", options: ["Academic excellence and competition", "Unity, perseverance, and self-belief", "The history of the school's founding", "Environmental conservation and awareness"], correct: 1, explanation: "The script was 'carefully woven with themes of unity, perseverance, and the importance of self-belief'." },
      { id: 108, text: "Pick the option that correctly identifies the mentor's advice to Rohan:", options: ["To speak as loudly as possible", "To memorize the script", "To avoid looking at teachers", "To connect emotionally with the words"], correct: 3, explanation: "The mentor said: 'Don't just read the words; feel their weight'." }
    ]
  },
  {
    id: "invincible-energy",
    title: "The Invincible Energy",
    description: "A philosophical reflection on the protective inner resilience of the human spirit.",
    content: "Within the human spirit lies an invincible energy, often dormant until the shadows of adversity stretch across our path. Ancient philosophies frequently personify this fierce, protective energy as a divine maternal force—a warrior who wields multiple weapons, not to wage wars of conquest, but to conquer the internal demons of doubt, ignorance, and despair. When life presents insurmountable challenges, it is this unyielding force that rises from the depths of our consciousness. It teaches us that true power is not found in aggression, but in the steadfast courage to protect one's values and inner peace. Just as a mother fiercely guards her child, this inner resilience guards our core identity against the chaotic forces of the world. Cultivating this energy requires absolute devotion to truth and a willingness to face our own fears without flinching. It is a reminder that even in the darkest of times, when negative thoughts multiply like an endless army, the radiant light of focused, righteous determination can dispel the gloom. Ultimately, to awaken this formidable energy is to realize that we are never truly defenseless; we carry the ultimate sanctuary and weapon within our own minds.",
    questions: [
      { id: 109, text: "What is the central idea of the passage?", options: ["Physical strength is necessary to conquer enemies", "Ancient philosophies are only for understanding war", "A fierce, protective inner energy exists within us to conquer internal challenges", "Devotion to truth is impossible in chaos"], correct: 2, explanation: "The passage focuses on the internal 'invincible energy' that helps overcome doubt and despair." },
      { id: 110, text: "Match the words with their appropriate Synonyms (Invincible, Dormant, Unyielding, Sanctuary):", options: ["A-II, B-I, C-IV, D-III", "A-IV, B-II, C-I, D-III", "A-I, B-IV, C-II, D-III", "A-II, B-III, C-IV, D-I"], correct: 0, explanation: "Invincible (Unbeatable), Dormant (Inactive), Unyielding (Resolute), Sanctuary (Safe haven)." },
      { id: 111, text: "The phrase 'when negative thoughts multiply like an endless army' is an example of which Figure of Speech?", options: ["Metaphor", "Simile", "Personification", "Oxymoron"], correct: 1, explanation: "The word 'like' creates a direct comparison (Simile) between thoughts and an army." },
      { id: 112, text: "According to the passage, what does the awakening of this energy teach us?", options: ["Aggression is the best way to handle adversity", "We should avoid facing our fears", "We carry the ultimate sanctuary and defense within our own minds", "Maternal forces are the only forces that matter"], correct: 2, explanation: "The conclusion states we carry 'the ultimate sanctuary and weapon within our own minds'." }
    ]
  },
  {
    id: "student-assessment",
    title: "The Evolution of Student Assessment",
    description: "How adaptive AI technology is shifting focus from memorization to mastery.",
    content: "The landscape of student evaluation is rapidly changing with the introduction of smart technology. An innovative concept gaining traction is an AI-powered student test app called SmarTest. Unlike traditional exams that offer a rigid set of questions, SmarTest adapts to the individual learning pace of each student. If a learner struggles with a specific concept, the algorithm intelligently recalibrates, offering targeted practice to fortify their understanding. This dynamic assessment model reduces test anxiety and transforms the testing environment from a purely evaluative tool into a personalized learning experience. Educators receive comprehensive analytics, enabling them to pinpoint exactly where a class needs intervention. By automating the grading process, teachers reclaim valuable time that can be redirected toward interactive instruction. As educational technology progresses, tools like this represent a crucial shift towards prioritizing mastery over mere memorization, ensuring that assessments are both fair and constructive.",
    questions: [
      { id: 113, text: "What is the central idea of the passage?", options: ["Traditional exams are entirely useless", "AI-powered tools are transforming assessments into personalized experiences", "Teachers are being replaced by automated systems", "Students no longer need to study"], correct: 1, explanation: "The focus is on how SmarTest and similar tools improve the assessment process." },
      { id: 114, text: "Choose the option that is the Antonym of the word 'rigid' as used in the passage:", options: ["Strict", "Inflexible", "Adaptable", "Severe"], correct: 2, explanation: "'Rigid' means inflexible; therefore, 'adaptable' is the correct opposite." },
      { id: 115, text: "According to the passage, how do comprehensive analytics benefit educators?", options: ["They allow teachers to leave the classroom early", "They force students to take traditional exams", "They automatically generate grades without teacher input", "They enable teachers to pinpoint exactly where intervention is needed"], correct: 3, explanation: "Analytics help teachers 'pinpoint exactly where a class needs intervention'." },
      { id: 116, text: "Choose the correct meaning of the word 'fortify' as used in the passage:", options: ["To weaken or undermine", "To build a physical castle", "To strengthen or reinforce", "To ignore a problem"], correct: 2, explanation: "'Fortify' means to strengthen or reinforce understanding of a concept." }
    ]
  },
  {
    id: "inkling-quest",
    title: "Inkling’s Quest for Order",
    description: "A whimsical tale of a punctuation mascot battling grammatical chaos.",
    content: "In the bustling town of Lexicon, words flowed freely, but sentences often collided in a chaotic jumble. The town desperately needed order. Enter Inkling, a small, spirited mascot shaped like a bright blue ink drop, whose sole mission was to teach punctuation to the unruly townsfolk. Armed with a silver comma-shield and a sharp period-sword, Inkling set out to tame the dreaded Run-On Dragon that was wreaking havoc in the town square. \"Hold your horses!\" Inkling shouted, throwing a perfectly timed semicolon into the dragon’s fiery breath of endless clauses. The dragon paused, confused by the sudden structural clarity. Seizing the moment, Inkling slashed with his period-sword, bringing the monster’s rambling roar to a definitive halt. The townspeople cheered as the dust settled. Through his brave and cleverly punctuated maneuvers, Inkling restored grammatical harmony to Lexicon, proving that even the longest, most exhausting trials could be conquered with a well-placed pause.",
    questions: [
      { id: 117, text: "Arrange the events of the narrative in the correct chronological order:", options: ["E, B, C, A, D", "B, E, C, A, D", "E, C, B, A, D", "C, A, E, B, D"], correct: 0, explanation: "Sequence: Sentences collided (E), Dragon wreaked havoc (B), Inkling threw semicolon (C), Monster's roar halted (A), Townspeople cheered (D)." },
      { id: 118, text: "Identify the Figure of Speech used in the creation of the 'Run-On Dragon':", options: ["Simile", "Personification / Metaphor", "Alliteration", "Oxymoron"], correct: 1, explanation: "The grammatical error is personified and metaphorically represented as a destructive beast." },
      { id: 119, text: "Choose the correct synonym for the word 'unruly' as used in the passage:", options: ["Obedient", "Disagreeable", "Disorderly", "Quiet"], correct: 2, explanation: "'Unruly' townsfolk are those who are disorderly or difficult to control." },
      { id: 120, text: "What is the overarching moral or message of Inkling's story?", options: ["Dragons are immune to silver", "A well-placed pause can conquer exhausting trials", "Blue ink is superior to black", "Town squares should be kept empty"], correct: 1, explanation: "The story is a metaphor for the power of punctuation to provide clarity and order." }
    ]
  },
  {
    id: "literary-analysis",
    title: "The Depths of Literary Analysis",
    description: "Developing empathy and wisdom through the rigorous study of classic literature.",
    content: "Engaging with classic literature is akin to conversing with the echoes of history. It requires a meticulous approach, much like a teacher developing resources for comprehensive literary analysis. When we dissect a poem or a novel, we are not simply looking for plot points; we are unearthing the profound themes of human existence—love, betrayal, ambition, and loss. A superficial reading merely skims the surface of the text, but a deep analysis plunges into the turbulent waters of metaphor, symbolism, and character motivation. It demands that the reader pause and question the author's intent. Why did the protagonist hesitate? What does the stormy weather signify? Through this rigorous intellectual exercise, readers develop empathy, stepping into the shoes of diverse characters across different eras. The ultimate value of studying literature lies not in memorizing lines for an examination, but in the enduring wisdom it imparts, allowing us to navigate our own modern complexities with a more enlightened and compassionate mind.",
    questions: [
      { id: 121, text: "Match the words with meanings (Meticulous, Superficial, Symbolism, Empathy):", options: ["A-III, B-II, C-I, D-IV", "A-II, B-III, C-I, D-IV", "A-I, B-IV, C-II, D-III", "A-II, B-I, C-IV, D-III"], correct: 1, explanation: "Meticulous (Attention to detail), Superficial (Lacking depth), Symbolism (Representative idea), Empathy (Sharing feelings)." },
      { id: 122, text: "According to the author, what is the ultimate value of studying literature?", options: ["To memorize famous lines", "To learn historical facts", "To gain enduring wisdom and empathy", "To quickly find plot points"], correct: 2, explanation: "The text emphasizes gaining 'enduring wisdom' and navigating 'complexities with a compassionate mind'." },
      { id: 123, text: "The phrase 'plunges into the turbulent waters of metaphor' is an example of:", options: ["Metaphor", "Simile", "Personification", "Alliteration"], correct: 0, explanation: "The process of analysis is directly compared to plunging into water without using 'like' or 'as'." },
      { id: 124, text: "Choose the option that is the Antonym of the word 'profound' as used in the passage:", options: ["Deep", "Intense", "Shallow", "Enlightening"], correct: 2, explanation: "'Profound' means deep; therefore, 'shallow' is its direct opposite." }
    ]
  }
]
