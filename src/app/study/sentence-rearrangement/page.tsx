    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12 max-w-5xl">
        <header className="mb-12">
          <Badge className="mb-4">Section 6 (40 Marks)</Badge>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
              ...
              <CardContent className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-4 items-start p-4 bg-white rounded-xl border">
                    ...
                    <div>
                      <h4 className="font-bold text-primary-foreground text-sm">{item.step}</h4>
                ...
                {[
                  ...
                  <Card key={i} className="border-none shadow-sm bg-muted/20">
                    <CardHeader className="pb-2">
                      <CardTitle className="text-xs font-bold uppercase tracking-wider text-primary-foreground">{p.pattern}</CardTitle>
                    </CardHeader>
                    <CardContent>
          ...
          <aside className="space-y-6">
            ...
            <Card className="border-secondary/30 bg-secondary/5">
              ...
              <CardContent className="text-[10px] leading-relaxed">
